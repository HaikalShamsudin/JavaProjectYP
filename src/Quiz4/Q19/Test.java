...
interface M {     // KALAU NAK ACCESS INTERFACE CLASS YANG ADA STATIC, CALLING THE METHOD MACAM NI M.log()
...
public class Test {
    ...
    public static void main(String[] args) {
        M obj1 = new MyClass();
        obj1.log(); // Because of static method log() on interface only can be invoke by using M.log(); //LINE 1
